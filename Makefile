...
TilesAndTowers-Linux-Debug:
	 $(PROJECTBUILD) TilesAndTowers Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowers-Linux-DebugGame:
	 $(PROJECTBUILD) TilesAndTowers Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowers-Linux-Shipping:
	 $(PROJECTBUILD) TilesAndTowers Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowers-Linux-Test:
	 $(PROJECTBUILD) TilesAndTowers Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowers:
	 $(PROJECTBUILD) TilesAndTowers Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowersEditor-Linux-Debug:
	 $(PROJECTBUILD) TilesAndTowersEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowersEditor-Linux-DebugGame:
	 $(PROJECTBUILD) TilesAndTowersEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowersEditor-Linux-Shipping:
	 $(PROJECTBUILD) TilesAndTowersEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowersEditor-Linux-Test:
	 $(PROJECTBUILD) TilesAndTowersEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TilesAndTowersEditor:
	 $(PROJECTBUILD) TilesAndTowersEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
